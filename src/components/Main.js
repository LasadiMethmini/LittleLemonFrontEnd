      ...
      <div className="banner">
        ...
        <div className="container">
          <div className="dish">
            ...
            <div className="desc">The famous Greek salad of crispy lettuce, peppers, olives and our Chicago-style feta cheese, garnished with crunchy garlic and rosemary croutons.</div>
          ...
          <div className="dish">
            ...
            <div className="desc">Our Bruschetta is made from grilled bread that has been smashed with garlic and seasoned with salt and olive oil.</div>
            <div className="bottom-text">
              <a href="/booking" className="delivery-link">
                <b>Order a delivery </b>
              </a>
          ...
          <div className="dish">
            ...
            <div className="desc">This comes straight from grandma's recipe book, every last ingredient has been sourced and authentic as can be imagined.</div>
            <div className="bottom-text">
              <a href="/booking" className="delivery-link">
                <b>Order a delivery </b>
              </a>
